...
- [ ] Implement `LCEP-COMP-001`: add a profile-level positive/negative composition matrix and fixtures for the existing local constants, state, and callable evaluator modes without expanding language semantics.
