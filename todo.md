...
- [ ] Remotely verify `LCEP-COMP-001` in the required seven-job Compiler Core matrix before calling its mode-separation evidence verified or changing public capability claims.
