...
- [ ] Remotely verify `LCEP-COMP-002` in the required seven-job Compiler Core matrix before calling its value-diversity evidence verified or changing public capability claims.
