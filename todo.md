...
- [ ] Implement and remotely verify a tag-aware non-publishing candidate workflow that accepts a validated tag input, rejects a tag-to-checkout mismatch, embeds the confirmed tag in the manifest, and retains the no-release-permission boundary.
