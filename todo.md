...
- [ ] Implement and remotely verify a non-publishing Linux/macOS/Windows synqc release-candidate workflow that produces CLI-only archives, SHA-256 and JSON manifests, content-allowlist checks, and clean-extraction smoke evidence for the exact source revision.
- [ ] Add and remotely verify optional GitHub provenance attestations for final-form candidate archives, documenting verification without representing provenance as a security certification.
