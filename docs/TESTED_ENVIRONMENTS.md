...
#32242711770](https://github.com/TangoSplicer/SynQ/actions/runs/32242711770)
for revision `d62b5ed`. Its Linux job passed the full **38/38** recovery-profile
CTest suite; distinct Windows MSVC and macOS Clang jobs each passed a **27-test**
...
[the same platform-matrix run](https://github.com/TangoSplicer/SynQ/actions/runs/32242711770).
...
> **Support boundary:** `windows-latest` has remote MSVC evidence for a 27-test
...
> 27-test Clang platform-neutral smoke profile **and** an experimental static-SDK
> clean-install external-consumer check. The full 38-test suite, the
...
with MSVC, and runs the platform-neutral 27-test profile. A distinct Windows
...
27-test platform-neutral compiler/CLI/C-ABI smoke profile as Windows. A separate
