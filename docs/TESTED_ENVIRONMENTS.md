...
#32247154982](https://github.com/TangoSplicer/SynQ/actions/runs/32247154982)
for revision `be18e0f`. Its Linux job passed the full **41/41** recovery-profile
CTest suite; distinct Windows MSVC and macOS Clang jobs each passed a **28-test**
...
[the same platform-matrix run](https://github.com/TangoSplicer/SynQ/actions/runs/32247154982).
...
> **Support boundary:** `windows-latest` has remote MSVC evidence for a 28-test
...
> 28-test Clang platform-neutral smoke profile **and** an experimental static-SDK
> clean-install external-consumer check. The full 41-test suite, the
...
with MSVC, and runs the platform-neutral 28-test profile. A distinct Windows
...
28-test platform-neutral compiler/CLI/C-ABI smoke profile as Windows. A separate
