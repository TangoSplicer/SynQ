...
including the 27-check recovery profile and experimental static native SDK path
in [Compiler Core #46][18]. The active
...
The preceding delivery-baseline recovery profile reported **26/26 passing** tests,
...
library, header, and CMake package and has remote clean-prefix evidence; it does
...
[18]: https://github.com/TangoSplicer/SynQ/actions/runs/31898767207 "SynQ Compiler Core #46"
