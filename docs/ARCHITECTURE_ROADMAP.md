...
| Core CMake profile | Builds C++17 library sources and registers focused smoke tests by default. | The default options keep historical optional targets off; [Compiler Core #35](https://github.com/TangoSplicer/SynQ/actions/runs/31848161711) validated the current 20-test profile, including the bounded qubit-declaration smoke, external OpenQASM validation, and C ABI consumers. |
