...
| Core CMake profile | Builds C++17 library sources and registers focused smoke tests by default. | The default options keep historical optional targets off; [Compiler Core #38](https://github.com/TangoSplicer/SynQ/actions/runs/31849244490) validated the preceding 22-test profile. The locally validated 23-test profile adds declaration-only callable provenance, rejection, and resolver-preservation coverage before the existing external OpenQASM validation and C ABI consumers. |
