...
| --- | --- | --- |
| Compiler core | **Remotely validated recovery profile.** | Builds `libsynq_lib.a`, `synqc`, test-only `libsynq_ffi.so`, and focused CTest consumers. Optional historical targets remain outside this claim. |
